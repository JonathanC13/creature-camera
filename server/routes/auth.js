...
const { login, getSelf, refreshToken, logout, updateUserInfo, updatePassword, forgotPassword, validateOTP } = require('../controllers/auth')
...
router.route('/info/:id').get(authorization, isValidObjId, getSelf)
